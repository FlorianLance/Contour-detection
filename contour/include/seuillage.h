...
class Seuillage{
    ...
    public:
        ...
        */
        IplImage *seuillageGlobal    (const IplImage*, const Gradient&, const unsigned int, Progression* = NULL) const;
        ...
        */
        IplImage *seuillageLocal     (const IplImage*, const Gradient&, const unsigned int, Progression* = NULL) const;
        ...
        */
        IplImage *seuillageHysteresis(const IplImage*,  Gradient&, const unsigned int, const bool, Progression* = NULL);

        /** @brief Retourne un affinage par extraction des maximas locaux de l'image en paramètre à partir de son gradient. */
        IplImage *seuillageExtractionMaximasLocaux(const IplImage*,Gradient&, Progression* = NULL) const;

        /** @brief Retourne un affinage par amincissement des contours de l'image en paramètre à partir de son gradient. */
        IplImage *seuillageAmincissementContours(const IplImage*, Gradient&, Progression* = NULL) const;

        /** @brief Retourne une image dont les contours ont été refermés. */
        IplImage* fermetureContours(const IplImage*,  Gradient&, const int, Progression* = NULL) const;
