...
class Gradient
{
    public:
        ...
        Gradient(const IplImage*, const Matrix&, const Matrix&, Progression* = NULL);

        /** @brief Constructeur de gradient avec une matrice horizontale, verticale, 45° et 135°.*/
        Gradient(const IplImage*, const Matrix&, const Matrix&, const Matrix& , const Matrix&, Progression* = NULL);
