...
{
    int val = (int)sqrt(pow((double)(p1.x() - p2.x()),2) + pow((double)(p1.y() - p2.y()),2));
            ...
            for(uint j = 0; j < tabConnexite[i].size(); j += tailleS)
            {
                ...
                if(j + tailleS < tabConnexite[i].size())
                {
                    ...
                    if(distance(tabConnexite.at(i)[j],tabConnexite.at(i)[j+tailleS] ) <= tailleS)
                    {
                        ...
                        int diffX = (int)sqrt(pow((double)(tabConnexite.at(i)[j].x() - tabConnexite.at(i)[j+tailleS].x()) ,2));
                        int diffY = (int)sqrt(pow((double)(tabConnexite.at(i)[j].y() - tabConnexite.at(i)[j+tailleS].y()) ,2));
...
{
    return (uint)sqrt(pow((double)(_p1.x() - _p2.x()),2)) + (uint)sqrt(pow((double)(_p1.y() - _p2.y()),2));
}
...
//    cout << (d <= 2) << " "<< (_diffX == 1 && _diffY == 1) << " " << ( d == 1) << " " << (d == 0)<< " | ";
    ...
    {
        QPoint pM((_p1 +_p2)/2);
        int diffX1 = (int)sqrt(pow((double)(_p1.x() - pM.x() ),2));
        int diffY1 = (int)sqrt(pow((double)(_p1.y() - pM.y() ),2));
        int diffX2 = (int)sqrt(pow((double)(_p2.x() - pM.x() ),2));
        int diffY2 = (int)sqrt(pow((double)(_p2.y() - pM.y() ),2));
